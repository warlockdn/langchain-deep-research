...
def head_to_head_evaluator(inputs: dict, outputs: list[dict]) -> list:
    grader_llm = ChatOpenAI(model="gpt-5", max_completion_tokens=20000)
...
single_agent = "DR Single Agent - OpenAI Search #-87e8a6c0"
multi_agent_supervisor = "DR Supervisor: Multi Agent - OpenAI Search #-cd25e7e3"
multi_agent_supervisor_v2 = "DR Supervisor: Multi Agent - OpenAI Search (v2) #-40967f53"
multi_agent_workflow = "DR MAW - OpenAI Search #-c6818a83"
